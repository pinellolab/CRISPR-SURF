...
parser.add_argument('-pert', '--perturbation', default = 'indel', type = str, choices = ['indel', 'crispri', 'crispra'], help = 'Perturbation type used in the CRISPR tiling screen experiment. This information is used to determine the perturbation index for a given sgRNA.')
