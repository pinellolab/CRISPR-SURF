...
parser.add_argument('-perturbation', '--perturbation', default = 'indel', type = str, choices = ['indel', 'crispri', 'crispra'], help = 'Perturbation type used in the CRISPR tiling screen experiment. This information is used to determine the perturbation index for a given sgRNA.')
...
parser.add_argument('-dropout_penalty', '--dropout_penalty', type = str, default = 'true', choices = ['t', 'true', 'yes', 'f', 'false', 'no'], help = 'The dropout penalty removes sgRNAs that have a 0 count in any of the control/sample replicates.')
parser.add_argument('-TTTT_penalty', '--TTTT_penalty', type = str, default = 'true', choices = ['t', 'true', 'yes', 'f', 'false', 'no'], help = 'The TTTT penalty removes sgRNAs that have a homopolymer stretch of Ts >= 4.')
