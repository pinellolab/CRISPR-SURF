...
parser.add_argument('-guide_l', '--guide_length', default = 20, type = str, help = 'Length of sgRNA')
...
genome = args.genome
pams = args.pams
spacer_orientations = [args.orientations[0]]*len(pams)
gRNA_length = int(args.guide_length)
...
sgRNAs_out = 'SURF_designed_sgRNAs.csv'
...
with open(out_dir + '/design_flag.txt', 'w') as f:
	f.write('DONE!')
