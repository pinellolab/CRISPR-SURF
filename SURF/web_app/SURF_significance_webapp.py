...
gammas2betas_updated, replicate_parameters = crispr_surf_statistical_significance(sgRNA_summary_table = UPLOADS_FOLDER + '/sgRNAs_summary_table.csv', sgRNA_indices = data_dict['sgRNA_indices'], perturbation_profile = data_dict['perturbation_profile'], gammas2betas = data_dict2['gammas2betas'], null_distribution = data_dict['null_distribution'], simulation_n = data_dict['sim_n'], test_type = data_dict['test_type'], guideindices2bin = data_dict['guideindices2bin'], averaging_method = data_dict['avg'], padj_cutoffs = [0.05], effect_size = data_dict['effect_size'], limit = data_dict['limit'], scale = data_dict['scale'], uploads_dir = UPLOADS_FOLDER, results_dir = RESULTS_FOLDER)
